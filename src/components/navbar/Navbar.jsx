    ...
    return (
        <>
            <Navbar
                ...
                style={{ background: mode === 'dark' ? '#641975' : '#641975' }}>
                ...
                <div className="flex items-center justify-between text-blue-gray-900">
                    ...
                    <Link to={'/'}>
                        ...
                        >
                            <img
                                className=' w-10 h-10 '
                                src='https://cdn-icons-png.flaticon.com/512/9623/9623631.png'
                            />
                            <span>
                                My Blog Platform
                            </span>
                        ...
                        <div>
                            ...
                            <Link to={'/dashBoard'}>
                                <div className="">
                                    <Avatar
                                        key={1}
                                        src={'https://cdn1.iconfinder.com/data/icons/banking-and-finance-8-1/128/352-512.png'}
                                        alt="avatar"
                                        withBorder={true}
