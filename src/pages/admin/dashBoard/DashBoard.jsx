                ...
                <div
                    ...
                    <div className="left">
                        <img
                            ...
                            src={'https://cdn1.iconfinder.com/data/icons/banking-and-finance-8-1/128/352-512.png'} alt="profile"
                        />
                    </div>
                    <div className="right">
                        <h1
                        ...
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">akshtest108@gmail.com
                        </h2>
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">
                                ...
                                {getAllBlog.length > 0
                                    ...
                                    <>
                                        {getAllBlog.map((item, index) => {
                                            const { image, date, id } = item; // Destructure blogs alongside image and date
                                            console.log(item)
                                            return (
                                                <tbody>
                                                    <tr className=" border-b-2" style={{ background: mode === 'dark' ? '#641975' : 'white' }}>
                                                        {/* S.No   */}
